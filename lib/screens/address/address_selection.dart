    ...
    setState(() {
      ...
      if (query.isEmpty) {
        ...
        final filtered = _buildings.where((building) {
          final name = building['name']?.toString() ?? building['ner']?.toString() ?? '';
    ...
    try {
      ...
      try {
        await ApiService.fetchWalletBilling(
          bairId: bairId,
          doorNo: doorNo,
          duureg: _selectedDistrict?['name']?.toString() ?? _selectedDistrict?['ner']?.toString(),
          horoo: _selectedKhoroo?['name']?.toString() ?? _selectedKhoroo?['ner']?.toString(),
                          ...
                          setModalState(() {
                            if (query.isEmpty) {
                              ...
                              filteredItems = items.where((item) {
                                final name = item['name']?.toString() ?? item['ner']?.toString() ?? '';
                                return name.toLowerCase().contains(query.toLowerCase());
                              }).toList();
                            }
                          });
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isSelected = selected != null &&
                                (selected['id']?.toString() ?? selected['_id']?.toString()) ==
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        selectedName ?? 'Сонгох...',
                        style: TextStyle(
                          color: selectedName != null ? Colors.white : Colors.white.withOpacity(0.5),
                          fontSize: 16.sp,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_selectedKhoroo != null)
                      _buildDropdown(
                        label: 'Барилга',
                        items: _filteredBuildings.isNotEmpty ? _filteredBuildings : _buildings,
